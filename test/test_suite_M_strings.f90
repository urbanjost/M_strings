...
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
subroutine test_percent_decode()
character(len=:),allocatable  :: s
character(len=:),allocatable  :: e
integer :: i
   call unit_test_start('percent_dncode','[ENCODE] percent-decode a string')
   s='%5Bthis%20is%20a%20string%5D'
   e='[this is a string]'
   ! add //'' to change function call to expression to avoid gfortran bug
   ...
   s='%00%01%02%03%04%05%06%07%08%09%0A%0B%0C%0D%0E%0F%10&
     ...
     &%F2%F3%F4%F5%F6%F7%F8%F9%FA%FB%FC%FD%FE%FF'
   ! add //'' to change function call to expression to avoid gfortran bug
   call unit_test('percent_decode',percent_decode(s) == e,  'entire ASCII256 set')

   call unit_test_end('percent_decode',msg='')
end subroutine test_percent_decode
!TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
