...
!===============================================================================
! *prep* ERROR(002) - unknown compiler directive: [@]: $@ (#) M_strings::trimzeros_(3fp): Delete trailing zeros from numeric decimal string
! Current state of prep(1):(08:58  4 Mar 2023)
! Total lines read ............... 7756
! Conditional nesting level....... 1
! G_WRITE (general processing).... T
! G_LLWRITE (write input lines)... T
! Arguments ...................... F90 GITHUB --noenv --comment doxygen --verbose -i M_strings.FF -o ../M_strings.F90 
! Open files:
!    unit ! line number ! filename
!      50 !        7756 ! M_strings.FF
! INCLUDE directories:
!    .
! Variables:(There are 13 variables defined)
!    $DEFINE WINDOWS  =  3
!    $DEFINE UNKNOWN  =  0
